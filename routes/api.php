 ...
 * Route API Category
 */
Route::get('/category', [CategoryController::class, 'index'])->name('customer.category.index');
...
Route::get('/cart/total-berat', [CartController::class, 'getCartTotalWeight'])->name('customer.cart.getCartTotalWeight');
